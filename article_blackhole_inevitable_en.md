...
Recent JWST rotation asymmetry [6] is consistent with the model’s emphasis on local optimisation.  Если эффект отражает космическое вращение, предпочитаемые направления лишь усилят центростремительный тренд; если это доплеровская перекалибровка, таймлайны просто масштабируются (Fig. 2), оставаясь конечными.
...
Generated by `get_phi_years.py`; doubling N_max adds ln 2 / ln φ ≈ 1.4427 years.
