...
![Informational Singularity Timeline — φ, conservative and big-data trajectories vs bound](viz/growth_curves.png)  
*Figure 1: Exponential growth curves (log scale) intersecting the Bekenstein bound. φ-curve hits at 2217; others labeled.*

![Robustness to Boundary Rescaling — doubling the bound](viz/robust_recal.png)  
...
![Informational Droplet Analogy — sharded vs centralized](viz/info_droplet.png)  
